...
import heroVideo from '../assets/hero video/neltech.mp4';
    ...
    <section className="relative w-full h-screen overflow-hidden bg-black">
      ...
      <div className="absolute inset-0 z-20 px-6 pb-20 md:pb-[8%] md:px-12 max-w-7xl mx-auto flex flex-col md:flex-row justify-end md:justify-between items-start md:items-end text-left w-full">
        ...
        <div className="flex flex-col items-start text-left max-w-2xl w-full">
          ...
          >
            Hi, I’m IT HIRWA LIONEL  <br /> <span className="text-transparent [-webkit-text-stroke:1.5px_black]">Full Stack Developer</span>
          </h1>
          ...
          >
            ...
            <a href="/cv.pdf" download className="px-4 py-2 md:px-6 md:py-2 text-xs md:text-base rounded-full bg-[#ff2a2a] text-white font-semibold hover:bg-white hover:text-black transition-all duration-300 transform hover:scale-105 shadow-md">
              Download CV
            </a>
          </div>
        </div>
